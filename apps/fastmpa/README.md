...
工作台使用 Tab/Shift+Tab 切换三栏焦点，方向键选择 Workspace 或 Conversation，Enter 发送消息；Ctrl+N 创建当前焦点对应的 Workspace/Conversation，Ctrl+R 重命名 Workspace，Ctrl+L 折叠日志，Ctrl+A 批准，Ctrl+X 拒绝或取消当前 Run，Ctrl+C 在有活动 Run 时取消、否则退出。
